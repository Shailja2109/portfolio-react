...
const Experience = ({ onSetPage }) => {
    ...
    return (<div id="Experience" className='text-center justify-center m-2 p-2 rounded-lg shadow-lg bg-purple-900 text-white'>
        {exp === 'None' && <div id="Companies">
            <div id="WebOccult">
                <button onClick={() => { setExp('Web') }}>
                    <p>WebOccult</p><p>Technologies</p>
                </button>

                {/* <img onClick={() => { setExp('Web') }} src='./Weboccult.png'></img> */}
            </div>
            <div id="Prototech">
                <button onClick={() => { setExp('Prot') }}>
                    <p>Prototech</p><p>Solutions</p>
                </button>
                {/* <img onClick={() => { setExp('Prot') }} src='./Prototech.png'></img> */}
            </div>
            <div id="Promact">
                <button onClick={() => { setExp('Prom') }}>
                    <p>Promact</p><p>Infotech</p>
                </button>
        ...
        {/* </div>} */}
        <Carousel id="card" value={skills} numVisible={3} numScroll={3} itemTemplate={productTemplate} responsiveOptions={"vertical"} />
